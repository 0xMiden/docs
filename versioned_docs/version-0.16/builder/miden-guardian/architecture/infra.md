...
| CloudWatch dashboard + alarms | [`observability.tf`](https://github.com/OpenZeppelin/guardian/blob/v0.17.0/infra/observability.tf) | `<stack>-server` dashboard; error-rate, latency, canonicalization, metrics-pipeline, and ECS saturation alarms. |
