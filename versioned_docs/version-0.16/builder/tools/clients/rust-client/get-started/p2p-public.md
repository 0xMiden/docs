...
In this section, we show you how to execute transactions and send funds to another account using the Miden client and [public notes](../../../../smart-contracts/notes/note-types.md).
...
:::tip
Remember to use the [Miden client documentation](../cli/index.md) for clarifications.
:::
...
3. On the new client, create a new [basic account](../../../../smart-contracts/accounts/introduction.md):
