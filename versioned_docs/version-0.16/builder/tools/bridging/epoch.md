...
:::warning v0.16 snapshot compatibility
This guide is frozen from a bridge portal revision that still uses Miden SDK v0.15. Confirm compatible allocator, faucet and solver deployments and validate a complete bridge round trip on your target network; this snapshot does not establish v0.16 interoperability.
:::
