...
This guide is frozen from a bridge portal revision that still uses Miden SDK v0.15. Confirm compatible provider deployments and validate an end-to-end transfer on your target network; this snapshot does not establish v0.16 interoperability.
:::
