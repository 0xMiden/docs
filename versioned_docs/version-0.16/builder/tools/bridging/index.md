...
These provider guides are frozen from the bridge portal documentation pinned on September 14, 2026. That portal still uses Miden SDK v0.15; inclusion here does not establish v0.16 compatibility. Confirm compatible provider deployments and validate an end-to-end transfer on your target network before relying on these flows.
:::
