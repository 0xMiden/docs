...
This complements the [Sequencer Failover](./sequencer.md) flow. Full nodes replicate the sequencer state
...
5. Restart the node as a sequencer. See [Sequencer](./sequencer.md).
