...
The [storage](https://docs.rs/miden-protocol/0.16.1/miden_protocol/account/storage/struct.AccountStorage.html) consists of up to 256 individual [storage slots](https://docs.rs/miden-protocol/0.16.1/miden_protocol/account/storage/struct.StorageSlot.html), where each slot consists of:
- Key: Slot name.
