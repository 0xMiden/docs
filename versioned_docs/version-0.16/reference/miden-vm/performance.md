...
When executed on a single CPU core, the current version of Miden VM operates at around 20 - 25 KHz. In the benchmarks below, the VM executes a [Blake3 example](https://github.com/0xMiden/miden-vm/tree/c1c2ddcb9cabc3d5c2071f8baf68c7930917cad8/miden-vm/masm-examples/hashing/blake3_1to1) program on Apple M4 Max CPU in a single thread. The generated proofs have a target security level of 96 bits.
