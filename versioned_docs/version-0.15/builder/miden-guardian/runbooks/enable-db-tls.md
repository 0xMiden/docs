...
This stack is driven by [`scripts/aws-deploy.sh`](https://github.com/OpenZeppelin/guardian/blob/v0.15.0/scripts/aws-deploy.sh)
...
because that variable is declared in [`infra/variables.tf`](https://github.com/OpenZeppelin/guardian/blob/v0.15.0/infra/variables.tf).
