...
| 2. Terraform | `guardian_ack_falcon_secret_name` / `_ecdsa_secret_name` | [`infra/variables.tf`](https://github.com/OpenZeppelin/guardian/blob/v0.15.0/infra/variables.tf), [`infra/data.tf:104-105`](https://github.com/OpenZeppelin/guardian/blob/v0.15.0/infra/data.tf#L104) | Creates / looks up the Secrets Manager entry and renders the ECS task definition. |
| 3. Runtime | `GUARDIAN_ACK_FALCON_SECRET_ID` / `_ECDSA_SECRET_ID` | The ECS task env, read by [`secrets_manager.rs:10-13`](https://github.com/OpenZeppelin/guardian/blob/v0.15.0/crates/server/src/ack/secrets_manager.rs#L10) | What the server actually consults at startup. |
...
1. **Deploy env (`_SECRET_NAME`).** If unset, the deploy script falls
   ...
   ([`aws-deploy.sh:324-329`](https://github.com/OpenZeppelin/guardian/blob/v0.15.0/scripts/aws-deploy.sh#L324)).
2. **Terraform variable.** If unset, defaults to
   ...
   ([`infra/ecs.tf:105-110`](https://github.com/OpenZeppelin/guardian/blob/v0.15.0/infra/ecs.tf#L105)).
...
What that command does ([`scripts/aws-deploy.sh`](https://github.com/OpenZeppelin/guardian/blob/v0.15.0/scripts/aws-deploy.sh)):
...
([`aws-deploy.sh:324-329`](https://github.com/OpenZeppelin/guardian/blob/v0.15.0/scripts/aws-deploy.sh#L324)). Mirror that
locally:
...
([`aws-deploy.sh:331`](https://github.com/OpenZeppelin/guardian/blob/v0.15.0/scripts/aws-deploy.sh#L331)) and fail fast
otherwise.
...
[`dashboard/allowlist.rs`](https://github.com/OpenZeppelin/guardian/blob/v0.15.0/crates/server/src/dashboard/allowlist.rs).
...
Both are **created and owned by Terraform** ([`infra/rds.tf:43`](https://github.com/OpenZeppelin/guardian/blob/v0.15.0/infra/rds.tf#L43),
[`infra/rds.tf:48`](https://github.com/OpenZeppelin/guardian/blob/v0.15.0/infra/rds.tf#L48)). Do not edit them by hand —
...
[`config/evm/chains.json`](https://github.com/OpenZeppelin/guardian/blob/v0.15.0/config/evm/chains.json) when
