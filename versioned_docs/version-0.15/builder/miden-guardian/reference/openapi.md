...
committed under [`docs/`](https://github.com/OpenZeppelin/guardian/blob/v0.15.0/docs), generated with the `evm` feature so they
document every route:

| File | Contents | Maps to |
| --- | --- | --- |
| [`openapi.json`](https://github.com/OpenZeppelin/guardian/blob/v0.15.0/docs/openapi.json) | combined client + dashboard + evm | served at runtime |
| [`openapi-client.json`](https://github.com/OpenZeppelin/guardian/blob/v0.15.0/docs/openapi-client.json) | client API only | `packages/guardian-client` |
| [`openapi-dashboard.json`](https://github.com/OpenZeppelin/guardian/blob/v0.15.0/docs/openapi-dashboard.json) | dashboard API only | `packages/guardian-operator-client` |
| [`openapi-evm.json`](https://github.com/OpenZeppelin/guardian/blob/v0.15.0/docs/openapi-evm.json) | EVM API only | `packages/guardian-evm-client` |
...
- **Client API** — three required `apiKey` headers, `x-pubkey`,
  `x-signature`, `x-timestamp` (see [`spec/api.md`](https://github.com/OpenZeppelin/guardian/blob/v0.15.0/spec/api.md)
