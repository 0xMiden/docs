...
[`spec/index.md`](https://github.com/OpenZeppelin/guardian/blob/v0.15.0/spec/index.md) first — this guide assumes you know them.
...
- Rust toolchain pinned by [`rust-toolchain.toml`](https://github.com/OpenZeppelin/guardian/blob/v0.15.0/rust-toolchain.toml).
...
([`builder/storage.rs:133`](https://github.com/OpenZeppelin/guardian/blob/v0.15.0/crates/server/src/builder/storage.rs#L133)).
...
([`builder/storage.rs`](https://github.com/OpenZeppelin/guardian/blob/v0.15.0/crates/server/src/builder/storage.rs)) and
...
([`infra/alb.tf:55`](https://github.com/OpenZeppelin/guardian/blob/v0.15.0/infra/alb.tf#L55)) would pass in production.

## Reaching for an example

| Example | What it exercises | SDK |
|---|---|---|
| [`examples/demo`](https://github.com/OpenZeppelin/guardian/blob/v0.15.0/examples/demo/README.md) | End-to-end multisig flow in a Rust TUI — recommended starting point. | Rust multisig client |
| [`examples/rust`](https://github.com/OpenZeppelin/guardian/blob/v0.15.0/examples/rust/README.md) | Low-level Rust binaries for both local-node and mockchain flows. | Rust client |
| [`examples/smoke-web`](https://github.com/OpenZeppelin/guardian/blob/v0.15.0/examples/smoke-web/README.md) | Browser harness for multisig + wallet integrations. | TS multisig client |
| [`examples/operator-smoke-web`](https://github.com/OpenZeppelin/guardian/blob/v0.15.0/examples/operator-smoke-web/README.md) | Local Falcon operator login + dashboard account APIs. | `@openzeppelin/guardian-operator-client` |
| [`examples/evm-smoke-web`](https://github.com/OpenZeppelin/guardian/blob/v0.15.0/examples/evm-smoke-web/README.md) | EVM proposal lifecycle against Anvil + an EVM-enabled server. | `@openzeppelin/guardian-evm-client` |
| [`examples/web`](https://github.com/OpenZeppelin/guardian/blob/v0.15.0/examples/web/README.md) | Reference web integration. | TS multisig client |
...
[`README.md`](https://github.com/OpenZeppelin/guardian/blob/v0.15.0/README.md#typescript-tests).

Cargo feature gates (`integration`, `e2e`) document what each suite
needs at the top of the relevant test modules under
[`crates/server/src/testing`](https://github.com/OpenZeppelin/guardian/blob/v0.15.0/crates/server/src/testing). Agents in
...
- **`DATABASE_URL` missing under `--features postgres`** — the builder
  ...
  ([`builder/storage.rs:97`](https://github.com/OpenZeppelin/guardian/blob/v0.15.0/crates/server/src/builder/storage.rs#L97)).
