...
For formal definitions and wire shapes, see [`spec/`](https://github.com/OpenZeppelin/guardian/blob/v0.15.0/spec/index.md). For
...
[`spec/index.md`](https://github.com/OpenZeppelin/guardian/blob/v0.15.0/spec/index.md#definitions). The supporting concepts
are:
...
single-tenant dev setups). See [`spec/processes.md`](https://github.com/OpenZeppelin/guardian/blob/v0.15.0/spec/processes.md#canonicalization)
...
- [Troubleshooting](../operations/troubleshooting.md) — error codes and recovery
  playbooks.
- [`spec/`](https://github.com/OpenZeppelin/guardian/blob/v0.15.0/spec/index.md) — formal specification.
