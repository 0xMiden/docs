...
Everything is in this directory: [`docker-compose.yml`](https://github.com/OpenZeppelin/guardian/blob/v0.15.0/docs/guides/postgres-tls/docker-compose.yml),
[`.env.example`](https://github.com/OpenZeppelin/guardian/blob/v0.15.0/docs/guides/postgres-tls/.env.example), and [`generate-certs.sh`](https://github.com/OpenZeppelin/guardian/blob/v0.15.0/docs/guides/postgres-tls/generate-certs.sh).
