...
Every setting is in one place — [`.env.example`](https://github.com/OpenZeppelin/guardian/blob/v0.15.0/docs/guides/aws-signers/.env.example) and
[`docker-compose.yml`](https://github.com/OpenZeppelin/guardian/blob/v0.15.0/docs/guides/aws-signers/docker-compose.yml) in this directory. For the
