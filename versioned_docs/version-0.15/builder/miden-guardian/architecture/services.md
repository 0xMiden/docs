...
([`crates/server`](https://github.com/OpenZeppelin/guardian/blob/v0.15.0/crates/server)) that fronts two transports
...
[`crates/server/src/lib.rs:3-30`](https://github.com/OpenZeppelin/guardian/blob/v0.15.0/crates/server/src/lib.rs#L3),
API submodules in
[`crates/server/src/api/mod.rs`](https://github.com/OpenZeppelin/guardian/blob/v0.15.0/crates/server/src/api/mod.rs),
service handlers in
[`crates/server/src/services/mod.rs`](https://github.com/OpenZeppelin/guardian/blob/v0.15.0/crates/server/src/services/mod.rs).
...
- **gRPC** ([`api/grpc.rs`](https://github.com/OpenZeppelin/guardian/blob/v0.15.0/crates/server/src/api/grpc.rs)) is the
  primary surface for the Rust client. Schema lives in
  `crates/server/proto/guardian.proto`. Default bind: `:50051`.
- **HTTP** ([`api/http.rs`](https://github.com/OpenZeppelin/guardian/blob/v0.15.0/crates/server/src/api/http.rs)) hosts the
...
- **Dashboard** ([`api/dashboard.rs`](https://github.com/OpenZeppelin/guardian/blob/v0.15.0/crates/server/src/api/dashboard.rs),
  [`api/dashboard_feeds.rs`](https://github.com/OpenZeppelin/guardian/blob/v0.15.0/crates/server/src/api/dashboard_feeds.rs))
  ...
  per-account auth.
- **EVM** ([`api/evm.rs`](https://github.com/OpenZeppelin/guardian/blob/v0.15.0/crates/server/src/api/evm.rs)) is the
  feature-gated EVM proposal API exposed when the server is built with the
  `evm` feature.

Both transports share the **middleware** stack
([`crates/server/src/middleware`](https://github.com/OpenZeppelin/guardian/blob/v0.15.0/crates/server/src/middleware)):
...
- **`state_object.rs` + `delta_object.rs`** ([`crates/server/src/state_object.rs`](https://github.com/OpenZeppelin/guardian/blob/v0.15.0/crates/server/src/state_object.rs),
  [`crates/server/src/delta_object.rs`](https://github.com/OpenZeppelin/guardian/blob/v0.15.0/crates/server/src/delta_object.rs))
...
- **`evm/`** ([`crates/server/src/evm`](https://github.com/OpenZeppelin/guardian/blob/v0.15.0/crates/server/src/evm)) —
  EVM proposal lifecycle, session auth, on-chain contract interaction.
  Feature-gated.
- **`jobs/`** ([`crates/server/src/jobs`](https://github.com/OpenZeppelin/guardian/blob/v0.15.0/crates/server/src/jobs)) —
  background work, currently canonicalization tasks that normalize proposals
  before commit.
- **`audit/`** ([`crates/server/src/audit`](https://github.com/OpenZeppelin/guardian/blob/v0.15.0/crates/server/src/audit))
...
- **`storage/`** ([`crates/server/src/storage`](https://github.com/OpenZeppelin/guardian/blob/v0.15.0/crates/server/src/storage))
  owns the heavy data: account state objects and delta history.
- **`metadata/`** ([`crates/server/src/metadata`](https://github.com/OpenZeppelin/guardian/blob/v0.15.0/crates/server/src/metadata))
  owns accounts, auth credentials
  ([`metadata/auth/`](https://github.com/OpenZeppelin/guardian/blob/v0.15.0/crates/server/src/metadata/auth)), and
  network/peer info.
...
[`crates/server/src/builder/storage.rs`](https://github.com/OpenZeppelin/guardian/blob/v0.15.0/crates/server/src/builder/storage.rs) —
...
1. **No durable audit trail.** The filesystem build wires up `LogAuditor`
   ...
   structured logs ([`builder/storage.rs:129-137`](https://github.com/OpenZeppelin/guardian/blob/v0.15.0/crates/server/src/builder/storage.rs#L129)).
...
2. **No migrations, no schema guarantees.** The Postgres path runs
   ...
   ([`builder/storage.rs:109`](https://github.com/OpenZeppelin/guardian/blob/v0.15.0/crates/server/src/builder/storage.rs#L109));
...
- Single-process examples under [`examples/`](https://github.com/OpenZeppelin/guardian/blob/v0.15.0/examples).
...
- [`ack/mod.rs`](https://github.com/OpenZeppelin/guardian/blob/v0.15.0/crates/server/src/ack/mod.rs) wires the signer.
- [`ack/miden_falcon_rpo/`](https://github.com/OpenZeppelin/guardian/blob/v0.15.0/crates/server/src/ack/miden_falcon_rpo)
  and [`ack/miden_ecdsa/`](https://github.com/OpenZeppelin/guardian/blob/v0.15.0/crates/server/src/ack/miden_ecdsa) hold the
  two scheme implementations.
- [`ack/secrets_manager.rs`](https://github.com/OpenZeppelin/guardian/blob/v0.15.0/crates/server/src/ack/secrets_manager.rs)
  ...
  ([`secrets_manager.rs:10-13`](https://github.com/OpenZeppelin/guardian/blob/v0.15.0/crates/server/src/ack/secrets_manager.rs#L10)).
...
[`crates/server/src/dashboard`](https://github.com/OpenZeppelin/guardian/blob/v0.15.0/crates/server/src/dashboard):
its own session/auth ([`authz.rs`](https://github.com/OpenZeppelin/guardian/blob/v0.15.0/crates/server/src/dashboard/authz.rs),
[`middleware.rs`](https://github.com/OpenZeppelin/guardian/blob/v0.15.0/crates/server/src/dashboard/middleware.rs)),
allowlist of operator public keys ([`allowlist.rs`](https://github.com/OpenZeppelin/guardian/blob/v0.15.0/crates/server/src/dashboard/allowlist.rs)),
permission model ([`permissions.rs`](https://github.com/OpenZeppelin/guardian/blob/v0.15.0/crates/server/src/dashboard/permissions.rs)),
shared state ([`state.rs`](https://github.com/OpenZeppelin/guardian/blob/v0.15.0/crates/server/src/dashboard/state.rs)),
and pagination cursor logic
([`cursor.rs`](https://github.com/OpenZeppelin/guardian/blob/v0.15.0/crates/server/src/dashboard/cursor.rs)).
...
- **Rust client** ([`crates/client`](https://github.com/OpenZeppelin/guardian/blob/v0.15.0/crates/client)) — gRPC client with
  auth ([`crates/client/src/auth`](https://github.com/OpenZeppelin/guardian/blob/v0.15.0/crates/client/src/auth)) and a
  pluggable keystore ([`crates/client/src/keystore`](https://github.com/OpenZeppelin/guardian/blob/v0.15.0/crates/client/src/keystore)).
- **Rust multisig SDK** ([`crates/miden-multisig-client`](https://github.com/OpenZeppelin/guardian/blob/v0.15.0/crates/miden-multisig-client))
  — builds on the Rust client; owns proposal creation, signing, execution,
  export/import, and the `SwitchGuardian` flow.
- **TS Guardian client** ([`packages/guardian-client`](https://github.com/OpenZeppelin/guardian/blob/v0.15.0/packages/guardian-client))
...
- **TS multisig SDK** ([`packages/miden-multisig-client`](https://github.com/OpenZeppelin/guardian/blob/v0.15.0/packages/miden-multisig-client))
  — TS counterpart of the Rust multisig SDK; browser-friendly.
- **Operator client** ([`packages/guardian-operator-client`](https://github.com/OpenZeppelin/guardian/blob/v0.15.0/packages/guardian-operator-client))
  — talks to the dashboard endpoints (HTTP, not gRPC).
- **EVM client** ([`packages/guardian-evm-client`](https://github.com/OpenZeppelin/guardian/blob/v0.15.0/packages/guardian-evm-client))
  — talks to `api/evm.rs` when the server is built with EVM support.

Smoke harnesses under [`examples/`](https://github.com/OpenZeppelin/guardian/blob/v0.15.0/examples) drive each SDK
...
1. **Per-account auth** — every mutating Guardian RPC is signed by the
   ...
   [`metadata/auth/`](https://github.com/OpenZeppelin/guardian/blob/v0.15.0/crates/server/src/metadata/auth) which loads
   credentials from the metadata store and dispatches to the right scheme
   ([`miden_falcon_rpo.rs`](https://github.com/OpenZeppelin/guardian/blob/v0.15.0/crates/server/src/metadata/auth/miden_falcon_rpo.rs),
   [`miden_ecdsa.rs`](https://github.com/OpenZeppelin/guardian/blob/v0.15.0/crates/server/src/metadata/auth/miden_ecdsa.rs)).
2. **Operator auth** — dashboard endpoints use Falcon-signed challenges
   ...
   Lives entirely in
   [`dashboard/authz.rs`](https://github.com/OpenZeppelin/guardian/blob/v0.15.0/crates/server/src/dashboard/authz.rs).
