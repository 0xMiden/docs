...
1. **Clock skew.** Timestamps must be within ±5 minutes of server time
   ([`metadata/auth/credentials.rs:6`](https://github.com/OpenZeppelin/guardian/blob/v0.15.0/crates/server/src/metadata/auth/credentials.rs#L6)).
...
By default
([`middleware/cors.rs`](https://github.com/OpenZeppelin/guardian/blob/v0.15.0/crates/server/src/middleware/cors.rs)) the
...
come from
[`crates/server/src/error.rs:206-247`](https://github.com/OpenZeppelin/guardian/blob/v0.15.0/crates/server/src/error.rs#L206).
...
`/ecs/<stack>-server` ([`infra/data.tf:88`](https://github.com/OpenZeppelin/guardian/blob/v0.15.0/infra/data.tf#L88)). Use ECS Exec
...
([`infra/iam.tf:115`](https://github.com/OpenZeppelin/guardian/blob/v0.15.0/infra/iam.tf#L115)) — already granted by default.
