...
Code references:
- Allowlist loader:
  [`crates/server/src/dashboard/allowlist.rs`](https://github.com/OpenZeppelin/guardian/blob/v0.15.0/crates/server/src/dashboard/allowlist.rs)
- Challenge/session issuance:
  [`crates/server/src/dashboard/authz.rs`](https://github.com/OpenZeppelin/guardian/blob/v0.15.0/crates/server/src/dashboard/authz.rs)
- Middleware that gates `/dashboard/*`:
  [`crates/server/src/dashboard/middleware.rs`](https://github.com/OpenZeppelin/guardian/blob/v0.15.0/crates/server/src/dashboard/middleware.rs)
- Permission vocabulary:
  [`crates/server/src/dashboard/permissions.rs`](https://github.com/OpenZeppelin/guardian/blob/v0.15.0/crates/server/src/dashboard/permissions.rs)
...
Defaults
([`crates/server/src/dashboard/config.rs`](https://github.com/OpenZeppelin/guardian/blob/v0.15.0/crates/server/src/dashboard/config.rs)):
...
shared by every task ([`config.rs:38`](https://github.com/OpenZeppelin/guardian/blob/v0.15.0/crates/server/src/dashboard/config.rs#L38)).

## Pagination

All list endpoints
([`services/dashboard_pagination.rs`](https://github.com/OpenZeppelin/guardian/blob/v0.15.0/crates/server/src/services/dashboard_pagination.rs))
...
([`GET /dashboard/deltas`](https://github.com/OpenZeppelin/guardian/blob/v0.15.0/crates/server/src/api/dashboard_feeds.rs))
also accepts a `status` filter
([`services/dashboard_global_deltas.rs`](https://github.com/OpenZeppelin/guardian/blob/v0.15.0/crates/server/src/services/dashboard_global_deltas.rs)):
...
([`permissions.rs`](https://github.com/OpenZeppelin/guardian/blob/v0.15.0/crates/server/src/dashboard/permissions.rs)).
...
([`error.rs:97-101`](https://github.com/OpenZeppelin/guardian/blob/v0.15.0/crates/server/src/error.rs#L97)). Read endpoints
...
([`services/pause_account.rs`](https://github.com/OpenZeppelin/guardian/blob/v0.15.0/crates/server/src/services/pause_account.rs),
[`services/unpause_account.rs`](https://github.com/OpenZeppelin/guardian/blob/v0.15.0/crates/server/src/services/unpause_account.rs)).
...
> ([`infra/operator_secrets.tf:12`](https://github.com/OpenZeppelin/guardian/blob/v0.15.0/infra/operator_secrets.tf#L12)),
...
at startup ([`allowlist.rs:70`](https://github.com/OpenZeppelin/guardian/blob/v0.15.0/crates/server/src/dashboard/allowlist.rs#L70));
...
4. **Alice logs in** — challenge → sign → session. The change takes
   ...
   ([`dashboard/state.rs:103-108`](https://github.com/OpenZeppelin/guardian/blob/v0.15.0/crates/server/src/dashboard/state.rs#L103),
   [`dashboard/state.rs:284-324`](https://github.com/OpenZeppelin/guardian/blob/v0.15.0/crates/server/src/dashboard/state.rs#L284)).
...
[`examples/operator-smoke-web`](https://github.com/OpenZeppelin/guardian/blob/v0.15.0/examples/operator-smoke-web) — it
...
[`examples/operator-smoke-web`](https://github.com/OpenZeppelin/guardian/blob/v0.15.0/examples/operator-smoke-web) README to
...
[`config.rs:16`](https://github.com/OpenZeppelin/guardian/blob/v0.15.0/crates/server/src/dashboard/config.rs#L16)),
