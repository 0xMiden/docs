...
- **Function/Procedure Calls**: Scripts that interact with deployed contracts through notes or [transaction scripts](/reference/miden-base/transaction#transaction-lifecycle)
