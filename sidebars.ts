...
const sidebars: SidebarsConfig = {
  builderSidebar: [
    ...
    },
    {
      ...
      // Pages under miden-guardian/ are ingested from OpenZeppelin/guardian at
      // deploy time (see .github/workflows/deploy-docs.yml + scripts/ingest-guardian.mjs);
      // autogenerate so the sidebar tracks the ingested set. Ordering comes from the
      // injected sidebar_position + the emitted _category_.json files. index.md is authored.
